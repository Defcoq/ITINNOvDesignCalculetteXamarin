...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ITINNovDesinCalculetteXamarin.Android.dll" comes first in this list. */
		"ITINNovDesinCalculetteXamarin.Android.dll",
		"AngouriMath.dll",
		"Antlr4.Runtime.Standard.dll",
		"FieldCache.dll",
		"FormsViewGroup.dll",
		"GenericTensor.dll",
		"ITINNovDesinCalculetteXamarin.dll",
		"Numbers.dll",
